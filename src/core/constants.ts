...
export const GRID_DIMENSION = 7; // Results in a GRID_DIMENSION x GRID_DIMENSION grid of tiles (use odd number for a center tile)

export const CAMERA_SPEED = 30.0; // Units per second
export const CAMERA_INITIAL_HEIGHT = 30.0;
